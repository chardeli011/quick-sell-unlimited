...
function Hero() {
  ...
  const HeroContent = ({ className = "", isSpotlight = false }: { className?: string, isSpotlight?: boolean }) => (
    <div className={`text-center max-w-4xl mx-auto ${className}`}>
      ...
      <h1 data-no-typewriter className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight">
        ...
        >
          <div className="relative w-full max-w-7xl aspect-video">
            <video
              ...
              muted
              playsInline
              aria-label="Quik Gateway de Pagamento em Ação"
