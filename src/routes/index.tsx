...
function LaptopDashboard() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen flex flex-col items-center justify-start bg-black overflow-hidden z-[50] pt-20">
      ...
      <div className="relative z-10 text-center mb-12 max-w-4xl px-6">
        <span className="chip mb-4">Tecnologia & Dados</span>
        <h2 className="font-display text-4xl md:text-6xl font-bold mb-4 text-white leading-tight">
